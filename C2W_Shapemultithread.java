...
public class C2W_Shapemultithread extends Application{
    ...
    public void start(Stage stage){
            ...
            final Scene c2w_scene=new Scene(c2w_root);
        ...
        private void c2w_redraw(){
            ...
            double c2w_heigth = c2w_canvas.getHeight();
            if(! c2w_running){
                c2w_g.setFill(Color.WHITE);
                c2w_g.fillRect(0,0,c2w_width,c2w_heigth);
                return; 
            }
            ...
            switch(c2w_artType){
                case 0:
                    ...
                    for(int i=0;i<500;i++){
                        ...
                        int y1=(int)(c2w_heigth * Math.random());
                        int x2=(int)(c2w_width * Math.random());
                        int y2=(int)(c2w_heigth * Math.random());
                ...
                case 1:
                    ...
                    for(int i=0;i<200;i++){
                        ...
                        int c2w_centerY = (int)(c2w_heigth * Math.random());
                        Color c2w_randomHue = Color.hsb(360 *Math.random(),1,1);
                        c2w_g.setStroke(c2w_randomHue);
                        c2w_g.strokeOval(c2w_centerX - 50, c2w_centerY,100,100);
                    }
                    break;
                    default:
                    ...
                    for(int i=0;i<25;i++){
                        ...
                        int centerY = (int)(c2w_heigth * Math.random());
